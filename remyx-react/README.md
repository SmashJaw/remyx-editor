...
| ---------------------------------------------------------------- | ---------- | ----------------------------------------------------------------------- |
| [`@remyxjs/core`](https://www.npmjs.com/package/@remyxjs/core)   | 1.0.4-beta | Framework-agnostic engine, commands, plugins, utilities, and CSS themes |
| [`@remyxjs/react`](https://www.npmjs.com/package/@remyxjs/react) | 1.0.4-beta | React components, hooks, and TypeScript declarations                    |
