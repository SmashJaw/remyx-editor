...
3. **Built-in defaults** — `theme: 'light'`, `height: 300`, etc.
...
// UI components
import { SaveStatus, RecoveryBanner, CommentsPanel, CollaborationBar } from '@remyxjs/react';
import { EditorErrorBoundary, Toast, useToast, EmptyState } from '@remyxjs/react';
import { BreadcrumbBar, Minimap, SplitPreview, TypographyDropdown } from '@remyxjs/react';

// Hooks
import { useDragDrop, useAutosave, useComments, useSpellcheck, useCollaboration } from '@remyxjs/react';
...
`@remyxjs/core` exports 90+ named symbols — the full engine, all 17 command register functions, plugin system (including syntax highlighting), autosave providers, utilities (markdown, paste cleaning, export, fonts, themes, toolbar config), and constants. See the [core package README](../remyx-core/README.md) for the full API.
...
@remyxjs/react
  ...
  hooks/
    ...
    useConfigFile.js      Config file loading from remyxjs/config/
